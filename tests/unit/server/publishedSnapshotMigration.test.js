...
beforeAll(async () => {
    ...
    await query('INSERT INTO projects (id, visibility, head_commit_id) VALUES ($1, $2, $3)', ['public-project', 'public', 'public-head']);
    await query('INSERT INTO projects (id, visibility, head_commit_id) VALUES ($1, $2, $3)', ['private-project', 'private', 'private-head']);
