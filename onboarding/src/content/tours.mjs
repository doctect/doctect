...
export const TOURS = [
    {
        ...
        steps: [
            ...
            { text: 'loadProjectState calls migrateState so document schemas advance v0 → v11 one version at a time before validation. Legacy localStorage document keys are retained only as read-only migration and recovery input. Epoch 1 has no cleanup, fallback, or dual-write path; old-tab or rollback drift blocks editing and preserves both sources instead of choosing a winner.',
