...
export const TOURS = [
    ...
    },
    {
        ...
        steps: [
            ...
            { text: 'Before anything is stored, validateAppState checks shape, a 5 MB size cap, and node/element count caps. It has exactly three call sites — project create, commits, and the merged result at the end of a merge. Publish is not one of them: it takes listing fields and an If-Match head, never a state.',
              files: ['server/validateAppState.js', 'server/routes/projects.js', 'server/routes/mergeRequests.js'], highlight: ['val'] },
