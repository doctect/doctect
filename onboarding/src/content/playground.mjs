    ...
    quizLevels: [
        { title: 'L1 · orientation', questions: [
            ...
            { q: 'Where does an anonymous user’s project live?',
              options: ['Legacy Web Storage (read-only migration source)', 'IndexedDB', 'A cloud draft keyed by cookie', 'The URL fragment'],
              answer: 1, why: 'Projects persist in IndexedDB; legacy browser storage is read only during migration, and cloud storage starts after an explicit “save to cloud”.' },
